...
$xoopsOption['xoops_pagetitle'] = $GLOBALS['xoopsModule']->name()
                                  . ' - '
                                  . $objInsinstr->getVar('title')
                                  . ' - '
                                  . $objInspage->getVar( 'title' );
// Шаблон
$xoopsOption['template_main'] = $moduleDirName
                                . '_page.tpl';
// Заголовок
...
if ( is_object( $GLOBALS['xoopsUser'] ) && $GLOBALS['xoopsUser']->isAdmin( $GLOBALS['xoopsModule']->mid() ) ) {
	...
	if( $gperm_handler->checkRight($moduleDirName
                                  . '_edit', $objInsinstr->getVar('cid'), $groups, $GLOBALS['xoopsModule']->getVar('mid') ) ) $pages['adminlink'] .= '<a href="'
                                  . XOOPS_URL
                                  . '/modules/'
                                  . $moduleDirName
                                  . '/submit.php?op=editpage&pageid='
                                  . $pages['pageid']
                                  . '"><img style="width:16px;" src="./assets/icons/edit_mini.png" alt='
                                  . _EDIT
                                  . ' title='
...
$navigation .= '<a href="'
                ...
                . $moduleDirName
                . '/index.php?cid='
                . $objInscat->getVar('cid')
                . '">'
                . $objInscat->getVar('title')
                . '</a>&nbsp;:&nbsp;';
$navigation .= '<a href="'
                . XOOPS_URL
                . '/modules/'
