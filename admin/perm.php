...
echo "<form method='get' name='fselperm' action='perm.php'><table><tr><td>
      <select name='permission' onChange='document.fselperm.submit()'><option value='1'"
      . $selected[0]
      . '>'
      . _AM_INSTRUCTION_PERM_VIEW
      . "</option><option value='2'"
      . $selected[1]
      . '>'
      . _AM_INSTRUCTION_PERM_SUBMIT
      . "</option><option value='3'"
      . $selected[2]
      . '>'
      . _AM_INSTRUCTION_PERM_EDIT
      . "</option></select></td></tr><tr></tr></table></form>";
...
$sql = 'SELECT cid, pid, title FROM '
        . $xoopsDB->prefix('instruction_cat')
        . ' ORDER BY title';
