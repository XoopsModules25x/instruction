<div id="help-template" class="outer">
    ...
    <p class="even">Instruction module is a Publishing Solution for your XOOPS Site<br><br>
    </p>
    ...
    <p class="even">If you have questions about this module and need help, you can visit our <a href="https://xoops.org/modules/newbb/" target="_blank">Support Forums on XOOPS Website</a></p>

    <h4 class="odd">DEVELOPMENT</h4>
    <p class="even">This module is Open Source and we would love your help in making it better! You can fork this module on <a href="https://github.com/aerograf/instruction" target="_blank">GitHub</a><br><br>
